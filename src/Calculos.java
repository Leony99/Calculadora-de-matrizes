public class Calculos {
    public int[][] somarMatrizes(Matriz matriz1, Matriz matriz2) {
        ...
        int[][] matrizResultante = new int[matriz1.getLinhas()][matriz2.getColunas()];
    ...
    public int[][] subtrairMatrizes(Matriz matriz1, Matriz matriz2) {
        if (matriz1.getLinhas() != matriz2.getLinhas()
                || matriz2.getColunas() != matriz2.getColunas()) {
            System.out.println("As matrizes precisam ser iguais em números de linhas e colunas.\n");
            return null;
    ...
    public int[][] multiplicarMatrizes(Matriz matriz1, Matriz matriz2) {
        ...
        int[][] matrizResultante = new int[matriz1.getElementos().length][matriz2.getElementos()[0].length];
        for (int i = 0; i < matrizResultante.length; i++) {
            for (int j = 0; j < matrizResultante[0].length; j++) {
                ...
                for (int aux = 0; aux < matriz1.getElementos()[0].length; aux++) {
                    int mult = matriz1.getElementos()[i][aux] * matriz2.getElementos()[aux][j];
                    somatorio += mult;
                }
